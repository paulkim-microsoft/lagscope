...
void print_usage()
{
	...
	printf("\t-P   [SENDER ONLY] prints 50th, 75th, 90th, 99th, 99.9th, 99.99th, 99.999th percentile of latencies. Optional argument for dumping frequency table into a json file\n");
